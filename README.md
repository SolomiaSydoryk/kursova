...
**Тестові дані** (після `python manage.py seed`):
- Адміністратор: Соломія Сидорик
- 7 секцій (Плавання, Фітнес, Пілатес, Волейбол, Теніс)
- 5 залів (Pilates Vibe, Fitness Hall, Aqua Center, Tennis Court, Volleyball Arena)
- 7 тренерів з різними спеціалізаціями
- Тестові бронювання для демонстрації
